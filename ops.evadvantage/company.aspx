            ...
            <div class="content1">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:Button ID="btnAdd" runat="server" Text="Add" Width="57px" OnClick="btnAdd_Click"
                                ValidationGroup="add" />
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                        <td align="left">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EVAConnectionString %>"
