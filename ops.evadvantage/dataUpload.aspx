                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" class="style4">
                                <tr>
                                    ...
                                    <td class="style8">
                                        <asp:TextBox ID="txtCompany" runat="server" CssClass="textbox" Width="179px">
                                        </asp:TextBox>
                                    </td>
                                    <td class="style6">
                                        &nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td class="style8">
                                        <asp:TextBox ID="txtfrom" Enabled="false"  runat="server" CssClass="textbox" Width="179px"></asp:TextBox></td>
                                    <td class="style6">
                                    ...
                                    <td align="left" class="style9">
                                        <asp:TextBox ID="txtto" Enabled="false" runat="server" CssClass="textbox" Width="179px"></asp:TextBox>
                                    </td>
                                    <td align="left">
