        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
                ...
                <td class="style2" colspan="5">
                    <asp:DropDownList ID="ddlClient" runat="server" CssClass="textbox" Width="405px">
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td class="style9">
                    <asp:TextBox ID="txtfrom" runat="server" CssClass="textbox" Width="161px"></asp:TextBox>
                </td>
                <td class="style4">
                ...
                <td class="style3">
                    <asp:TextBox ID="txtto" runat="server" CssClass="textbox" Width="161px"></asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td class="style6" colspan="2">
                    <asp:Button ID="btnGen" runat="server" Text="View Data" OnClick="btnGen_Click" Style="height: 26px" />
