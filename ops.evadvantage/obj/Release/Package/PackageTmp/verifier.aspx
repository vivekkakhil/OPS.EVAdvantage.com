<%@ Page Language="C#" MasterPageFile="EVAadmin.master" AutoEventWireup="true" CodeFile="verifier.aspx.cs" Inherits="Admin_verifier" Title="Verifier Information" %>
...
<table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td >
                            <asp:Label ID="Label16" runat="server" CssClass="label" 
                                Text="Search verifier and view the status of the verifier."></asp:Label>
                        </td>
                        <td align="right">
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                    ...
                    <td align="left">
                       &nbsp;<img src="../images/action_help.gif" onmousemove="showToolTip(event,'To search all the verifiers please select Search By option and enter * in Search For.');return false" onmouseout="hideToolTip()"/>
                              ...
                              <tr>
                                  <td>
                                      <asp:Label ID="Label3" runat="server" 
                                          style="font-size: small; font-weight: 700; text-decoration: underline; color: #003399" 
                                          Text="Verifier Detail"></asp:Label>
                                  </td>
                                  <td align="right">
                                      &nbsp;
                                  </td>
                                  ...
                                  <td>
                                      <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" 
                                          ...
                                          <Columns>
                                              ...
                                              <asp:BoundField DataField="ExpiredDate" HeaderText="Verification Date" 
