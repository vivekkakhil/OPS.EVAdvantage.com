<%@ Page Language="C#" MasterPageFile="~/EVA.master" AutoEventWireup="true" CodeFile="EmploymentSalary.aspx.cs"
    Inherits="EmploymentSalary" Title="Employment and Salary Verification Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript">
        ...
        function printdiv(printpage) {
            var headstr = "<html><head><title></title></head><body><div style='width:100%; text-align:center;'><img width='200' src='images/image001.png' align='center'/></div><h3>Employment and Salary Verification</h3><br />";
            var footstr = "</body>";
            ...
            <div id="div_print" runat="server" class="content">
                ...
                <table cellpadding="0" cellspacing="0" class="style1">
                    <tr>
                        ...
                        <td rowspan="20" align="center" colspan="2">
                            <table width="60%">
                                <tr>
                                    <td align="center" style="background-color: Silver; border-style: solid; border-color: Black;
                                        border-width: thin;">
                                        <b>Disclaimer</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="justify" style="border-style: solid; border-color: Black; border-width: thin;">
                    ...
                    <tr>
                        ...
                        <td class="style4">
                            <asp:Label ID="lblempbd" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="style8">
                    ...
                    <tr>
                        ...
                        <td class="style9">
                            <asp:Label ID="Label36" runat="server" Text="Gross Wage :"></asp:Label>
                        </td>
                        <td class="style4">
                    ...
                    <tr>
                        ...
                        <td class="style9">
                            <asp:Label ID="Label27" runat="server" Text="Overtime Pay :"></asp:Label>
                        </td>
                        <td class="style4">
                            <asp:Label ID="lblovertime" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="style6">
                        ...
                        <td class="style4">
                            <asp:Label ID="lblrbasis" runat="server"></asp:Label>
                        </td>
                        <td class="style9">
                            <asp:Label ID="Label31" runat="server" Text="Commission Pay :"></asp:Label>
                        </td>
                        <td class="style4">
                    ...
                    <tr>
                        ...
                        <td class="style9">
                            <asp:Label ID="Label37" runat="server" Text="Bonus Pay :"></asp:Label>
                        </td>
                        <td class="style4">
                    ...
                    <tr>
                        ...
                        <td class="style4">
                            <asp:Label ID="lblcbpr" runat="server"></asp:Label>
                        </td>
                        <td class="style9">
                    ...
                    <tr>
                        ...
                        <td class="style4">
                            <asp:Label ID="lblmrcir" runat="server"></asp:Label>
                        </td>
                        <td class="style9">
                            <asp:Label ID="Label39" runat="server" Text="Other Pay :"></asp:Label>
                        </td>
                        <td class="style4">
                    ...
                    <tr>
                        ...
                        <td class="style9">
                            <asp:Label ID="Label40" runat="server" Text="Net Pay :"></asp:Label>
                        </td>
                        <td class="style4">
                    ...
                    <tr runat="server" id="tr2" visible="false">
                        <td colspan="4" style="font-size: 12px; color: Red; text-align: center;">
                            <asp:Label ID="lblSavageMsg" runat="server" Text="A good-faith effort shall be made to retrieve and provide previous DOT record information, for verification purposes, free of charge, per part 382 of the DOT code, within the 30 day required time period."></asp:Label>
                        </td>
                    </tr>
                    <tr runat="server" id="tr3" visible="false">
                        <td colspan="4" style="font-size: 12px; color: Red; text-align: center;">
                            <asp:Label ID="Label33" runat="server" Font-Italic="true" Text="This wage verification is applicable to all employees of Pacific Dental Services, Inc. (“PDS®”) and its Affiliated Entities.  The statement refers to totals from your employer(s), whether that is PDS or an Affiliated Entity. PDS’ human resources and payroll department provide support in the administration of employee policies to PDS and all Affiliated Entities."></asp:Label>
                        </td>
                    </tr>
                    <tr runat="server" id="tr4" visible="false">
                        <td colspan="4" style="font-size: 12px; color: Red; text-align: center;">
                            <asp:Label ID="Label34" runat="server" Font-Italic="true" Text="Statement for gross earnings may include the following: base pay rate and tier adjustment or guarantee earnings rate."></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4" class="style6">
