<%@ Page Title="" Language="C#" MasterPageFile="~/Login.master" AutoEventWireup="true" CodeFile="SSNewUserN.aspx.cs" Inherits="SocialService_SSNewUserN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <td colspan="2" style="padding-top: 10px; padding-bottom: 30px;"><h3>
        Create Social Service Verifier:</h3>
   </td>
   </tr>
                    <tr>
                        <td>
