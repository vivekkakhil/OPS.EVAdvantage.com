<%@ Page Language="C#" MasterPageFile="EVASsv.master" AutoEventWireup="true" CodeFile="SSNewUser.aspx.cs"
    Inherits="SocialService_SSNewUser" Title="Create New Social Verification User" %>
            ...
            <div class="content1">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            Text="Once your request for an account has been received by UC Advantage, Inc.  We will e-mail you confirmation, and your client number for access.  If you should have any questions regarding this process, please contact us at info@ucadvantage.net." />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlState" runat="server" Width="164px" CssClass="textbox">
                            </asp:DropDownList>
