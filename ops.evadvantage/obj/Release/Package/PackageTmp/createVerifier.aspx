<%@ Page Language="C#" MasterPageFile="~/EVA.master" AutoEventWireup="true" CodeFile="createVerifier.aspx.cs"
    Inherits="createVerifier" Title="Verifier Registration" %>
        ...
        <ContentTemplate>
            <div class="content">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <asp:Label ID="Label16" runat="server" Text="Please fill up the following information to activate your account."
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtCadd1"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlState" runat="server" Width="158px" CssClass="textbox">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCountry" runat="server" Width="158px" Text="United States" CssClass="textbox"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtTele"
                                ErrorMessage="Please enter work telephone.">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" class="style3">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtBusiness"
                                ErrorMessage="Please enter type of business.">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" class="style3" style="white-space: nowrap;">
                            &nbsp;&nbsp;&nbsp;<asp:Label ID="Label12" runat="server" Text="Employee's Company Name to be Verified :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtEmpCompany" runat="server" CssClass="textbox" Width="158px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" valign="top" class="style3">
                            <asp:Label ID="Label30" runat="server" Font-Bold="True" ForeColor="Red" Text="*"></asp:Label>
                            <asp:Label ID="Label31" runat="server" Text="Reason(s) for Obtaining Verification :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtReason" runat="server" TextMode="MultiLine" Width="296px" Height="93px"
                                CssClass="textbox"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtReason"
                                ErrorMessage="Please enter reason for obtaining verification.">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" class="style3">
                            <asp:Label ID="Label40" runat="server" Font-Bold="True" ForeColor="Red" Text="*"></asp:Label>
                            <asp:Label ID="Label41" runat="server" Text="User Name :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtUser" runat="server" Width="158px" CssClass="textbox"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txtUser"
                                ErrorMessage="Please enter username.">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" class="style3">
                            <asp:Label ID="Label32" runat="server" Font-Bold="True" ForeColor="Red" Text="*"></asp:Label>
                            <asp:Label ID="Label33" runat="server" Text="Password :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtPwd" runat="server" TextMode="Password" Width="158px" CssClass="textbox"></asp:TextBox>
                    ...
                    <tr>
                        <td align="left" class="style3">
                            <asp:Label ID="Label34" runat="server" Font-Bold="True" ForeColor="Red" Text="*"></asp:Label>
                            <asp:Label ID="Label35" runat="server" Text="Re - Type Password :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtRePwd" runat="server" TextMode="Password" Width="158px" CssClass="textbox"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtRePwd"
                                ErrorMessage="Please enter re-type password.">*</asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPwd"
                                ControlToValidate="txtRePwd" ErrorMessage="Password and Re-Type password should be same.">*</asp:CompareValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" class="style3">
                            <asp:Label ID="Label36" runat="server" Font-Bold="True" ForeColor="Red" Text="*"></asp:Label>
                            <asp:Label ID="Label37" runat="server" Text="Secret Question :"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlQuestion" runat="server" Width="296px" CssClass="textbox">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="ddlQuestion"
                                ErrorMessage="Please select secret question." InitialValue="0">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" class="style3">
                            <asp:Label ID="Label38" runat="server" Font-Bold="True" ForeColor="Red" Text="*"></asp:Label>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="txtAns"
