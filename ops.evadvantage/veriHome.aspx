<%@ Page Language="C#" MasterPageFile="~/EVA.master" AutoEventWireup="true" CodeFile="veriHome.aspx.cs" Inherits="veriHome" Title="Verifier Home" %>
              ...
              <tr>
                  <td class="style2" colspan="2">
                      <asp:Label ID="Label16" runat="server" CssClass="label" 
                          Text="Please fill up the following information for verification"></asp:Label>
                  </td>
              </tr>
              <tr>
                  <td class="style3">
              ...
              <tr>
                  ...
                  <td>
                      <asp:DropDownList ID="ddlType" runat="server" AutoPostBack="True" 
                          ...
                          onselectedindexchanged="ddlType_SelectedIndexChanged" Width="167px">
                      </asp:DropDownList>
              ...
              <tr id="trKey" runat="server">
                  ...
                  <td>
                      ...
                      <asp:RequiredFieldValidator ID="RfvKey" runat="server" 
                          ...
                          ErrorMessage="Please enter Salary Authorization Code.">*</asp:RequiredFieldValidator>
                  </td>
              </tr>
              <tr>
                  <td class="style3">
                  ...
                  <td>
                      ...
                      <asp:TextBox ID="txtSSN" runat="server" CssClass="textbox" 
              ...
              <tr id="trValid" runat="server">
                  ...
                  <td>
                      ...
                      &nbsp;<asp:Button ID="btnClear" runat="server" Text="Clear" 
                          Width="57px" CausesValidation="False" onclick="btnClear_Click" />
                      &nbsp;</td>
              </tr>
