<%@ Page Language="C#" MasterPageFile="~/EVA.master" AutoEventWireup="true"  CodeFile="employees.aspx.cs" Inherits="employees" Title="Employee" %>
...
<div class="content">
 <table width="400" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      <table id="tblLogin" runat="server" width="375" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td colspan="3" height="33px" align="left"><img src="images/eLogin.gif" width="150" height="33" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="3" align="left"><ul>
              ...
              <li>Generate a salary information key</li>
            </ul></td>
        </tr>
        <tr>
          <td colspan="3" height="10px"></td>
          ...
          <td colspan="3">
              <table width="375" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td  align="left">
                      <asp:TextBox ID="txtUser" runat="server" CssClass="textbox" OnTextChanged="txtUser_TextChanged"></asp:TextBox>
                ...
                <tr>
                  ...
                  <span>Request your <a href="VWE_Request_Form.pdf" style="color: Blue; text-decoration: none;" target="_blank">(VWE)</a> Verification of Wage and Employment (annual disclosure)</span>
                      </td>
                </tr>
