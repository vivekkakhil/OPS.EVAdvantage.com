<%@ Page Language="C#" MasterPageFile="~/EVA.master" AutoEventWireup="true" CodeFile="terms.aspx.cs" Inherits="terms" Title="Terms of Use" %>
...
<strong>AGREEMENT BETWEEN USER AND EVAdvantage</strong><br /><br />

The EVAdvantage Web Site is comprised of various Web pages operated by EVAdvantage.<br /><br />

The EVAdvantage Web Site is offered to you conditioned on your acceptance without modification of the terms, conditions, and notices contained herein. Your use of the EVAdvantage Web Site constitutes your agreement to all such terms, conditions, and notices.<br /><br />

<strong>MODIFICATION OF THESE TERMS OF USE</strong><br /><br />

EVAdvantage reserves the right to change the terms, conditions, and notices under which the EVAdvantage Web Site is offered, including but not limited to the charges associated with the use of the EVAdvantage Web Site.<br /><br />

<strong>NO UNLAWFUL OR PROHIBITED USE</strong><br /><br />
